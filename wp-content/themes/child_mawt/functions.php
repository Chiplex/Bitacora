...
if ( !function_exists( 'mawt_scripts' ) ):
    function mawt_scripts () 
    {
        ...
        wp_register_script( 'scripts', get_stylesheet_directory_uri() . '/script.js', array('jquery', 'parent-scripts'), '1.0.0', true );
...
// El prefijo Child evita que desaparezca la imagen principal de las entradas
