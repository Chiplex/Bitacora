...
//  Scripts
if (!function_exists('mawt_login_script') ):
    function mawt_login_script()
    {
        // Estilos
...
add_action('login_enqueue_scripts', 'mawt_login_script');

// Configuracion del vinculo que aparece como logo en el login de Wordpress
...
// Configuracion del titulo del vinculo que aparece como logo en el login de Wordpress
